...
// Só cria cliente OpenAI se houver chave válida (formato sk-...)
const openaiApiKey = process.env.AI_INTEGRATIONS_OPENAI_API_KEY;
const hasValidOpenAIKey = openaiApiKey?.startsWith('sk-');

export const openai = hasValidOpenAIKey
  ? new OpenAI({
      apiKey: openaiApiKey,
...
export async function voiceChat(
  ...
  if (!openai) {
    throw new Error("OpenAI não configurado. Configure AI_INTEGRATIONS_OPENAI_API_KEY.");
  }
